...
import com.cmall.mall.util.DateUtil;
import com.cmall.mall.util.JwtUtils;
import com.cmall.mall.util.StringUtil;
...
import com.cmall.mall.util.*;
import com.cmall.mall.properties.WeixinpayProperties;
...
public class OrderController {
    ...
    public R preparePay(@RequestBody String orderNo)throws Exception{
        ...
        map.put("body","cmall.mallmall商品购买测试");
